...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <?php echo form_open('tempatwisata/form_save');?>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"> 
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <div class="input-group">
                ...
                <textarea name="alamat" id="alamat" cols="70" rows="4"></textarea>
              </div>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <div class="input-group">
                ...
                <input id="skor_rating" name="skor_rating" type="number" max="5" min="1" class="form-control">
              </div>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <div class="input-group">
                ...
                <input id="kecamatan_id" name="kecamatan_id" type="number" class="form-control">
              </div>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <div class="input-group">
               ...
               <textarea name="fasilitas" id="fasilitas" cols="70" rows="4"></textarea>
              </div>
            </div>
          </div>
          <div class="form-group row">
